...
AGGREGATOR_KEYS = {"Rewards/rew_extr_avg", "Rewards/rew_intr_avg", "Game/ep_len_avg", "Loss/value_loss_extr", "Loss/value_loss_intr", "Loss/policy_loss", "Loss/entropy_loss"}
